...
def make_wordcloud_pic():
    ...
    with open('./bilibili/视频弹幕/all.csv', mode='r') as f:
        txt = f.read()
    ...
    # 词云图的轮廓
    img = imageio.imread('./bilibili/outline/p.png')
    """
    ...
    wc = wordcloud.WordCloud(
        ...
        stopwords=set([
            line.strip()
            for line in open('./bilibili/stop_words/cn_stopwords.txt',
                             mode='r',
    ...
    # 保存云图
    wc.to_file('./bilibili/视频弹幕/all_词云.png')
    return 0
